const experiences = [
  {
    ...
    highlights: [
      ...
      "Tradução de requisitos de negocio em soluções técnicas orientadas por dados e definição de KPIs",
    ],
  },
  {
    title: "Analista de Dados",
    ...
    location: "Mato Grosso do Sul, BR",
    current: false,
    description: "Apoio a gestão com dashboards, análises e processos de ETL para garantir qualidade dos dados.",
    highlights: [
      "Construção de dashboards e relatórios analíticos para apoio a decisão",
